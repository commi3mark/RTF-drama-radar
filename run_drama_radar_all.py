...
def main() -> int:
    stages = [
        ...
        (
            "Transcript download",
            [sys.executable, str(ROOT / "download_transcripts.py")],
        ),
        (
            "Transcript index",
        ...
        (
            "OCTOPUSS evidence packets",
            [sys.executable, str(ROOT / "build_octopuss_packets.py")],
        ),
        (
            "OCTOPUSS packet validation",
